...
class Handle {
  ...
  register(id = '', ref, update = true) {
    ...
    _objectPath.default.set(this.handles, path, ref);
  ...
  unregister(id = '') {
    ...
    _objectPath.default.del(this.handles, path);
  ...
  get(id = '') {
    const path = Array.isArray(id) ? id : id.split('.');
    return _objectPath.default.get(this.handles, path);
  }
  /**
